...
cd config
cp Stereo3D_example $CONFIG_FILEconfig.py
...
./launcher/det_precompute.sh config/$CONFIG_FILEconfig.py test
...
./disparity_precompute.sh config/$CONFIG_FILEconfig.py $IsUsingPointCloud
