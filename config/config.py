...
## path
path = edict()
path.data_path = "/home/ubuntu/Masterarbeit/object_detection/data/KITTI/training" # used in visualDet3D/data/.../dataset
path.test_path = "/home/ubuntu/Masterarbeit/object_detection/data/KITTI/testing" # used in visualDet3D/data/.../dataset
path.visualDet3D_path = "/home/ubuntu/Masterarbeit/object_detection/YOLOStereo3D/visualDet3D/visualDet3D" # The path should point to the inner subfolder
path.project_path = "/home/ubuntu/Masterarbeit/object_detection/YOLOStereo3D/visualDet3D/work" # or other path for pickle files, checkpoints, tensorboard logging and output files.
