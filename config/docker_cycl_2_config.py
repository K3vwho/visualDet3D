...
## path
path = edict()
path.data_path = "/workspace/data/KITTI/training" # used in visualDet3D/data/.../dataset
path.test_path = "/workspace/data/KITTI/testing" # used in visualDet3D/data/.../dataset
path.visualDet3D_path = "/workspace/visualdet3d/visualDet3D" # The path should point to the inner subfolder
path.project_path = "/workspace/visualdet3d/work_cycl" # or other path for pickle files, checkpoints, tensorboard logging and output files.
