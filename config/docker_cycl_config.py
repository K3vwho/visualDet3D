...
## path
path = edict()
path.data_path = "/home/data/KITTI/training" # used in visualDet3D/data/.../dataset
path.test_path = "/home/data/KITTI/testing" # used in visualDet3D/data/.../dataset
path.visualDet3D_path = "/home/YOLOStereo3D/visualDet3D/visualDet3D" # The path should point to the inner subfolder
path.project_path = "/home/YOLOStereo3D/visualDet3D/work_cycl" # or other path for pickle files, checkpoints, tensorboard logging and output files.
# path.pretrained_checkpoint = "" #path to the last checkpoint for further training
